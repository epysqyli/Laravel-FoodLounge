                    ...
                    <div class="col-md-6">
                        <input id="image" type="file"
                            class="d-block form-control-file @error('image') is-invalid
                                    @enderror"
                            name="image" autocomplete="image" {{ count(Auth::user()->types) == 0 ? 'disabled' : '' }}>
                        @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="additional_details" type="text" value="{{ old('additional_details') }}"
                            class="form-control" name="additional_details" autocomplete="additional_details" rows="3"
                            {{ count(Auth::user()->types) == 0 ? 'disabled' : '' }}>{{ old('additional_details') }}
                                                    </textarea>
                    </div>
                </div>
